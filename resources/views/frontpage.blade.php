			...
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header">
						...
						<nav>
							<ul>
								<li><a href="#intro">Chokolade</a></li>
								<li><a href="#work">Filosofi</a></li>
					...
					<div id="main">
						...
						<!-- Intro -->
							<article id="intro">
								...
								<span class="image main"><img src="{{ asset('storage/img/pic01.jpg') }}" alt="" /></span>
						...
						<!-- Work -->
							<article id="work">
								<h2 class="major">Filosofi</h2>
								<span class="image main"><img src="{{ asset('storage/img/pic02.jpg') }}" alt="" /></span>
						...
						<!-- About -->
							<article id="about">
								...
								<span class="image main"><img src="{{ asset('storage/img/pic03.jpg') }}" alt="" /></span>
